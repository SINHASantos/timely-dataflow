...
## [0.32.0](https://github.com/SINHASantos/timely-dataflow/compare/timely-v0.31.0...timely-v0.32.0) - 2026-09-12

### Other

- Remove Notificator, FrontierNotificator, unary_notify, and binary_notify ([#819](https://github.com/SINHASantos/timely-dataflow/pull/819))
- Remove operators that read a time off the capability, and the flow-control and Result helpers ([#818](https://github.com/SINHASantos/timely-dataflow/pull/818))
- :time() requires TotalOrder and returns Option ([#817](https://github.com/SINHASantos/timely-dataflow/pull/817))
- Cheaper coordination among workers: poll before parking, fewer signals, serialize broadcasts once ([#816](https://github.com/SINHASantos/timely-dataflow/pull/816))
- Messages stamped by sets of capabilities ([#813](https://github.com/SINHASantos/timely-dataflow/pull/813))
