...
## [0.25.0](https://github.com/SINHASantos/timely-dataflow/compare/timely-v0.24.0...timely-v0.25.0) - 2025-09-27

### Other

- Provide access for wrapped builder ([#717](https://github.com/SINHASantos/timely-dataflow/pull/717))
- Pivot container builders above capability checking ([#715](https://github.com/SINHASantos/timely-dataflow/pull/715))
- Add and use `InputSession` ([#716](https://github.com/SINHASantos/timely-dataflow/pull/716))
- Remove Container argument from Counter ([#714](https://github.com/SINHASantos/timely-dataflow/pull/714))
- Remove Hash from Timestamp ([#713](https://github.com/SINHASantos/timely-dataflow/pull/713))
- Remove IterContainer ([#707](https://github.com/SINHASantos/timely-dataflow/pull/707))
- Replace ExchangeCore with DistributePact ([#711](https://github.com/SINHASantos/timely-dataflow/pull/711))
- Create pact for Distributors ([#709](https://github.com/SINHASantos/timely-dataflow/pull/709))
