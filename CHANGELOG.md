...
## [0.27.0](https://github.com/SINHASantos/timely-dataflow/compare/timely-v0.26.1...timely-v0.27.0) - 2026-03-04

### Other

- Return input stream ([#747](https://github.com/SINHASantos/timely-dataflow/pull/747))
- MRSV 1.86 ([#748](https://github.com/SINHASantos/timely-dataflow/pull/748))
- Avoid allocations when sorting ([#751](https://github.com/SINHASantos/timely-dataflow/pull/751))
- Assert if a second pusher is added without upgrading ([#750](https://github.com/SINHASantos/timely-dataflow/pull/750))
- Reorganize types and traits to deprioritize `Vec` streams ([#746](https://github.com/SINHASantos/timely-dataflow/pull/746))
- Replace seeded rand datagen with hash functions ([#745](https://github.com/SINHASantos/timely-dataflow/pull/745))
- `Tee` implementation without `Clone` requirement ([#744](https://github.com/SINHASantos/timely-dataflow/pull/744))
- Bump oldest Rust version from 1.79 to 1.85 ([#743](https://github.com/SINHASantos/timely-dataflow/pull/743))
- Delay/retain input capabilities for specific outputs ([#738](https://github.com/SINHASantos/timely-dataflow/pull/738))
